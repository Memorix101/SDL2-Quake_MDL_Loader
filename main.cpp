...
bool init()
{
	...
	else
	{
		...
		//Create window
		gWindow = SDL_CreateWindow("SDL OpenGL 3.1 Render", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_OPENGL | SDL_WINDOW_SHOWN);
		if (gWindow == NULL)
		{
